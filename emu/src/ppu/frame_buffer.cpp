...
frame_buffer::image_span frame_buffer_locked_view::span() const noexcept {
    return frame_buffer::image_span(my_frame_buffer.my_front_buffer.data(), frame_buffer::image_span::extent);
}
