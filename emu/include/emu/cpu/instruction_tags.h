...
namespace cpu_detail { struct instruction_tag_base {}; }

/** CPU instruction tag type. */
template<class InstructionTag>
concept instruction_tag =
    std::derived_from<InstructionTag, cpu_detail::instruction_tag_base> &&
...
#define EMU_DEFINE_INSTRUCTION_TAG(InstructionTag)                      \
    struct InstructionTag : cpu_detail::instruction_tag_base {              \
